                ...
                <form @submit.prevent="submitLogin">
                    ...
                    <div class="">
                        ...
                        <div class="mb-3">
                            ...
                            <input v-model="loginForm.email" id="emailLogin" type="email" class="form-control" required
                        ...
                        <div class="mb-4">
                            ...
                            <input v-model="loginForm.password" id="passwordLogin" type="password" class="form-control"
