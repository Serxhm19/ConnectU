                    ...
                    <div class="tabs">
                        <div class="tab-container">
                            ...
                            <div id="tab3" class="tab">
                                <div class="tab-icon">🎤</div>
                                <span>{{ $t('register_as_promoter') }}</span>
                            </div>
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="container">
                                            <div class="row justify-content-center my-5">
                                                <form @submit.prevent="submitLogin">
                                                    <!-- Tipo de usuario -->
                                                    <div class="mb-3">
                                                        <label for="userType" class="form-label">{{ $t('user_type')
                                                        }}</label>
                                                        <select v-model="loginForm.userType" id="userType"
                                                            class="form-select">
                                ...
                                <!-- Contenido de la pestaña de registro de promotor -->
                                ...
                                <!-- Agrega más contenido de pestañas si es necesario -->
                            </div>
                        </div>
                    </div>
                </div>
