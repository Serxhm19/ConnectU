                ...
                <div class="w-100 flex justify-content-between">
                    <div class="w-50 m-4">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <div class="ml-2">
                                <input v-model="event.start_date" class="form-control" type="datetime-local" name="start_date"/>
                            </div>
                        </div>
                        ...
                        <div class="form-gorup mb-2">
                            ...
                            <div class="ml-2">
                                <input v-model="event.end_date" class="form-control" type="datetime-local" name="end_date"/>
                            </div>
                        </div>
                        </div>
