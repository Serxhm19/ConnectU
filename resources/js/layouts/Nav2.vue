                    ...
                    <div class="Account">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <img v-if="user.profile_image_url" :src="user.profile_image_url" alt="Profile Picture"
                                    class="user-logo">
                                <img v-else src="/images/default-profile-image.png" alt="Default Profile Picture"
                                    class="user-logo">
                                {{ user.name }}
                            </a>
